...
% 构建时域 PSS:
% 原结构: [Block0(-B), B, B, B, B, B, B, B]
% 新要求: 反相块放到第3个 (Index 2, 0-based)
% 结构变更为: [B, B, Block2(-B), B, B, B, B, B]
pss_signal = [pss_block_base, pss_block_base, -pss_block_base, repmat(pss_block_base, 1, 5)];
